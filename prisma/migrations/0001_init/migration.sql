-- ============================================================
-- ELIGNITE TRAINING PLATFORM — Full PostgreSQL Baseline Migration
-- Safe to run against an existing DB (all statements use IF NOT EXISTS)
-- ============================================================
...
CREATE TABLE IF NOT EXISTS "Teacher" (
    ...
    CONSTRAINT "Teacher_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE
);
...
-- TeacherProgram (many-to-many: Teacher ↔ Program)
...
-- StudentProgram (many-to-many: Student ↔ Program, up to 2 per student)
...
CREATE TABLE IF NOT EXISTS "Course" (
    ...
    CONSTRAINT "Course_programId_fkey" FOREIGN KEY ("programId") REFERENCES "Program"("id") ON DELETE SET NULL,
    CONSTRAINT "Course_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "Teacher"("id") ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "Enrollment" (
    ...
    CONSTRAINT "Enrollment_approvedBy_fkey" FOREIGN KEY ("approvedBy") REFERENCES "User"("id") ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "Result" (
    ...
    CONSTRAINT "Result_studentId_courseId_semester_year_key" UNIQUE ("studentId", "courseId", "semester", "year"),
    CONSTRAINT "Result_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE,
    CONSTRAINT "Result_courseId_fkey"  FOREIGN KEY ("courseId")  REFERENCES "Course"("id")
);
...
CREATE TABLE IF NOT EXISTS "Fee" (
    ...
    CONSTRAINT "Fee_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Attendance" (
    ...
    CONSTRAINT "Attendance_studentId_courseId_date_key"   UNIQUE ("studentId", "courseId", "date"),
    CONSTRAINT "Attendance_studentId_fkey"                FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE,
    CONSTRAINT "Attendance_courseId_fkey"                 FOREIGN KEY ("courseId")  REFERENCES "Course"("id")
);
...
CREATE TABLE IF NOT EXISTS "Announcement" (
    ...
    CONSTRAINT "Announcement_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Certificate" (
    ...
    CONSTRAINT "Certificate_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Testimony" (
    ...
    CONSTRAINT "Testimony_userId_fkey"   FOREIGN KEY ("userId")     REFERENCES "User"("id") ON DELETE CASCADE,
    CONSTRAINT "Testimony_approvedBy_fkey" FOREIGN KEY ("approvedBy") REFERENCES "User"("id") ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "Project" (
    ...
    CONSTRAINT "Project_teacherId_fkey" FOREIGN KEY ("teacherId") REFERENCES "Teacher"("id") ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS "ProjectScore" (
    ...
    CONSTRAINT "ProjectScore_projectId_studentId_key" UNIQUE ("projectId", "studentId"),
    CONSTRAINT "ProjectScore_projectId_fkey"         FOREIGN KEY ("projectId") REFERENCES "Project"("id")  ON DELETE CASCADE,
    CONSTRAINT "ProjectScore_studentId_fkey"         FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "Timetable" (
    ...
    CONSTRAINT "Timetable_courseId_dayOfWeek_startTime_semester_year_key" UNIQUE ("courseId", "dayOfWeek", "startTime", "semester", "year"),
    CONSTRAINT "Timetable_courseId_fkey"                                  FOREIGN KEY ("courseId") REFERENCES "Course"("id") ON DELETE CASCADE
);
