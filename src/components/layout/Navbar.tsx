...
export function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-slate-200/70 bg-white/92 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3 text-slate-950">
          <div className="relative h-11 w-11 overflow-hidden rounded-md border border-slate-200 bg-white shadow-sm">
          ...
          <div className="leading-tight">
            ...
            <p className="text-[11px] uppercase tracking-[0.18em] text-slate-500">School Platform</p>
          </div>
        </Link>
