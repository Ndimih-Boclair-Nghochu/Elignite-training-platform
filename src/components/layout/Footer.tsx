    ...
    <footer className="border-t border-white/10 bg-[#07111f]">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1fr] lg:px-8">
        <div className="space-y-4">
          <p className="text-sm font-semibold uppercase tracking-[0.25em] text-cyan-300">ELIGNITE</p>
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Quick Links</h4>
          <div className="mt-4 space-y-3">
            {quickLinks.map((link) => (
              <Link key={link.href} href={link.href} className="block text-sm text-slate-400 transition-colors hover:text-white">
                {link.label}
              </Link>
            ))}
          </div>
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Popular Tracks</h4>
          <div className="mt-4 space-y-3">
        ...
        <div>
          <h4 className="text-sm font-semibold uppercase tracking-[0.22em] text-slate-300">Contact</h4>
