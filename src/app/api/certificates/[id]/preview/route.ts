  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media print {
      ...
      .certificate-container { box-shadow: none; border-width: 2px; }
    }
  </style>
</head>
<body>
  <div class="certificate-container">
    ...
    return NextResponse.json(
      { error: "Failed to generate certificate preview", details: error instanceof Error ? error.message : String(error) },
      { status: 500 }
    );
  }
}
