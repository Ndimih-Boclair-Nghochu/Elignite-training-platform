...
export default function ActivateAccountPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-950 px-4 py-10">
      <div className="grid w-full max-w-5xl overflow-hidden border border-white/10 bg-white shadow-2xl lg:grid-cols-[0.92fr_1.08fr]">
        <div className="hidden bg-[linear-gradient(145deg,#0f172a,#082f49)] p-10 text-white lg:flex lg:flex-col lg:justify-between">
          <div>
            ...
            <h1 className="mt-8 text-4xl font-semibold leading-tight">
              Activate your school account with the identifier and email on file.
            </h1>
        ...
        <div className="p-6 sm:p-8 lg:p-10">
          <Card className="border-0 shadow-none">
            <CardHeader className="px-0 pt-0">
              <CardTitle className="text-3xl">Activate Account</CardTitle>
              <CardDescription>
                Set your password and unlock your portal access.
              </CardDescription>
            </CardHeader>
